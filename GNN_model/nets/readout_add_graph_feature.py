...
class readout_add_graph_feature(torch.nn.Module):
    def __init__(self, dataset, dim_linear, dim_conv, processing_steps, mp_times):
        super().__init__()
        ...
        self.lin2 = torch.nn.Linear(dim_conv, 1)
